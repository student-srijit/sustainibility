            ...
            <CardContent className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-8 text-center space-y-6">
                  ...
                  <Button className="bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white rounded-full px-6 py-3 transform hover:scale-105 transition-all duration-300">
                    Get Reduction Tips
